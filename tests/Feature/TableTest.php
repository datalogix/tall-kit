...
class TableTest extends TestCase
{
    ...
    {
        $this->registerTestRoute('table.sortable');

        $this->visit('/table.sortable')
            ->seeInElement('table>thead>tr>th', 'ID')
            ->dontSeeElement('table>thead>tr>th .desc')
            ->seeInElement('table>thead>tr>th', 'Name')
            ->seeElement('table>thead>tr>th .asc');
    }

    public function testSortableSlot()
    {
        $this->registerTestRoute('table.sortable-slot');

        $this->visit('/table.sortable-slot')
            ->seeInElement('table>thead>tr>th', 'ID')
            ->seeElement('table>thead>tr>th .asc')
            ->seeInElement('table>thead>tr>th', 'Name')
            ->seeElement('table>thead>tr>th .desc');
    }
}
